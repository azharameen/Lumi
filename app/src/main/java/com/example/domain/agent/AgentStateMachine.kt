...
class AgentStateMachine(
    ...
    private fun mergeStates(base: AgentState, update: AgentState): AgentState {
        ...
        return base.copy(
            ...
            selectedModelId = update.selectedModelId ?: base.selectedModelId,
            ...
            currentThought = update.currentThought ?: base.currentThought,
            pendingToolName = update.pendingToolName,
            pendingToolArgs = update.pendingToolArgs,
            hitlRequired = update.hitlRequired || base.hitlRequired,
            executedToolReports = if (update.executedToolReports.isNotEmpty()) update.executedToolReports else base.executedToolReports,
            retryCount = maxOf(base.retryCount, update.retryCount),
            reflectionCount = maxOf(base.reflectionCount, update.reflectionCount),
            failureSignatures = if (update.failureSignatures.isNotEmpty()) update.failureSignatures else base.failureSignatures,
            currentNodeName = update.currentNodeName,
